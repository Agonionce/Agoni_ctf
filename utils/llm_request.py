...
class LLMRequest:
    ...
    def text_completion(
        ...
        **kwargs: Any,
        ...
        messages = []
        if system_prompt:
            messages.append({"role": "system", "content": optimize_text(system_prompt)})
        messages.append({"role": "user", "content": optimize_text(prompt)})
